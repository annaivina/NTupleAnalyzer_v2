...
void ATLASLabel(Double_t x,Double_t y,char* text=NULL,Color_t color=1, float size=-1.); 
...
void myText(Double_t x,Double_t y,Color_t color,char *text, float size=-1); 
